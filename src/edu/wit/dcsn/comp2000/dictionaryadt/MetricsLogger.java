 ...
 * 
 * <p>
 * Note: You must use this class, without modification, in your Comp 2000, Dictionary/Hash
 * Table ADT solution.
 */
 ...
 * @version	1.1.0	2018-07-26	updates for consistency with other code for this course
 */
public final class MetricsLogger
	...
	/**
	 * Creates and opens the metrics log file HashTable.metrics in the default location
	 * (project root folder). If the file already exists, it is replaced.
	 * 
	 ...
	 * 
	 * @param bucketCount
	 *        the size of the hash table array (the maximum number of buckets the hash
	 *        table can currently hold
	 * @param bucketsInUse
	 *        the number of buckets (elements in the array) which have been instantiated
	 *        (note that a bucket can be in use and contain no entries if the last one has
	 *        been remove()d.)
	 ...
	 *        if true, the next table size will be twice the current size increased to the
	 *        next higher prime number; if false, the next table size will simply be twice
	 *        the current size.
	 */
