...
/**
 * Contains a sample inner class TableEntry - primarily to demonstrate how to implement
 * equals()
 */
 ...
 * <p>
 * WARNING:<br>
 * The Java Class Library's LinkedList class uses K's equals() rather than TableEntry's
 * equals(). This means that the handling of both aTableEntry.equals(anotherTableEntry)
 * and aTableEntry.equals(aKey) are both supported but our equals() will only get called
 * if we give LinkedList's contains() or indexOf() a TableEntry as the parameter - calling
 * them with a key as the parameter always fails to match.
 * 
 * <p>
 * To use a TableEntry as the parameter to LinkedList methods, instantiate a TableEntry
 * with the key and specify null for the value:
 * 
 * <pre>
 ...
 * @version 1.0.0 Example TableEntry inner class - from Dictionary implementation
 * 
...
public class TableEntryExample<K, V>
	...
	private class TableEntry
		...
		public boolean equals( Object otherObject )
			...
			// WARNING: Must search with a TableEntry rather than the key because
			// LinkedList uses the key's class' equals() method, not the element's!!! So,
			// for now, the key handling portion of this method will not execute
			K otherKey ;
